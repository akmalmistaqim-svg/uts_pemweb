            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <?php if ($row['role'] === 'pengguna'): ?>
                  ...
                  <a href="proses/prosesAdmin.php?aksi=jadikan_admin&id=<?php echo $row['id']; ?>"
                ...
                <?php else: ?>
                  ...
                  <a href="proses/prosesAdmin.php?aksi=jadikan_pengguna&id=<?php echo $row['id']; ?>"
                ...
                <?php if ($row['email'] !== $_SESSION['email']): ?>
                  <a href="proses/prosesAdmin.php?aksi=hapus&id=<?php echo $row['id']; ?>"
